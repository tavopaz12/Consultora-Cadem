<title>Redacción para Ejecutivos | Habilidades Generales y ventas-Cadem</title>

	<div class="informacion-de-cursos-banner" style='background-image: url("../img/redaccion-ejecutivos2.jpg");'>
		<div class="informacion-de-cursos-banner-contenedor">
			<h1>Redacción para Ejecutivos</h1>
			<hr>
			<p>Palabras que Proyectan Imagen Profesional y de Negocios</p>
		</div>
	</div>
  		...
  		<div class="column2-informacion-de-cursos">
    		<div id="Informacion" class="w3-container w3-border city">
    			<div class="content">
    				<h1>INTRODUCCIÓN</h1>
    				<br>
    				<p>Desarrollar su habilidad de redacción en forma efectiva con los diferentes tipos de documentos que se realizan en su área de trabajo, de acuerdo a los lineamientos gramaticales, con objeto de crear un estilo sencillo y fácil de comprender para el receptor.</p>
    			</div>
    			...
    			<div class="content">
    				...
    				<p>
    					<ul>
						  	<li>Logrará eficacia en su comunicación.</li>
						  	<li>Descubrirá la buena imagen que proyecta saber escribir correctamente nuestro idioma.</li>
						  	<li>Creará un estilo profesional de negocios.</li>
						  	<li>Podrá apoyar al personal de su área que dude en la aplicación de términos o conceptos.</li>
						</ul>
    				</p>
    			</div>
    			...
    			<div class="content">
    				...
    				<br>
    				<ul>
    					<li>Asistentes Ejecutivos, Secretarias Ejecutivas, Recepcionistas y Profesionales en general. Con o sin experiencia.</li>
    				</ul>			
    			</div>
  			</div>
  			...
  			<div id="Temario" class="w3-container w3-border city" style="display:none">
			    ...
			    <p>
			    	<ul class="ul2">
			    		<li>Venda ideas claras, concisas y bien estructuradas</li>
			    		<hr>
			    		<li>Comuníquese de manera eficaz con sus clientes y prospectos</li>
			    		<hr>
			    		<li>Lingüística: Fonología, Gramática, Semántica</li>
			    		<hr>
			    		<li>Normas generales de ortografía</li>
			    		<hr>
			    		<li>Principios generales de la redacción</li>
			    		<hr>
			    		<li>Estructura de un escrito</li>
			    		<hr>
			    		<li>Estilística</li>
			    		<hr>
			    		<li>Importancia de la redacción</li>
			    	</ul>
			    </p> 
  			</div>
			    ...
			    <div class="content">
			    	<h1>PROGRAMACIÓN</h1>
					    ...
					    <table>
					    	...
					    	<tr>
					    		<td>15/06/19 al 05/07/2019</td>
					    		<td>2 semanas</td>
					    		<td>Tezonapa, ver</td>
					    	</tr>

					    	<tr>
					    		<td>15/07/19 al 05/08/2019</td>
					    		<td>2 semanas</td>
					    		<td>Tezonapa, ver</td>
					    	</tr>
					    </table>	
			    	...
			    	<form action="" method="post" name="fcontacto">
				    	...
				    	<div class="form-column1-infocursos">
				    		<p>
								...
								<br>
								<input type="text" class="input-text" value="Redacción para Ejecutivos" name="nombreDelCurso" required readonly>
							</p>
				    		...
				    		<div id="paIndividual">
								<p>
					    			...
					    			<select name="fechaSolicitadaIndivi" id="" class="input-select">
					    				...
					    				<option value="1">15/06/19 al 05/07/2019</option>
					    				<option value="2">15/07/19 al 05/08/2019</option>
					    			</select>
								</p>
