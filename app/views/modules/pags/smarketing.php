<title>Smarketing | Mercadotecnia y ventas-Cadem</title>

	<div class="informacion-de-cursos-banner" style='background-image: url("../img/smartketing2.jpg");'>
		<div class="informacion-de-cursos-banner-contenedor">
			<h1>Smarketing</h1>
			<hr>
			<p>Mercadotecnia, Ventas y Comunicación hacia la Comercialización Inteligente</p>
		</div>
	</div>
  		...
  		<div class="column2-informacion-de-cursos">
    		<div id="Informacion" class="w3-container w3-border city">
    			<div class="content">
    				<h1>INTRODUCCIÓN</h1>
    				<br>
    				<p>Proporcionar la metodología y herramientas necesarias para que las Empresas, de cualquier giro y tamaño, desarrollen y ejecuten su Plan Estratégico y orgánicamente alineado de Comercialización.</p>
    				<p>A través de la metodología logramos que Ventas, Mercadotecnia y Comunicación trabajen hacia un mismo objetivo sin desperdicio de esfuerzos, recursos ni distracciones, y con métricas e indicadores de éxito comunes y compartidos.</p>
    			</div>
    			...
    			<div class="content">
    				...
    				<p>
    					<ul>
						  	<li>Rectificarás el rumbo estratégico de tu compañía.</li>
						  	<li>Identificarás las estrategias de Ventas, Mercadotecnia y Comunicación más apropiadas para generar oportunidades de negocio y posicionamiento para tu marca, productos o Empresa.</li>
						  	<li>Vincularás operativamente las áreas de Ventas, Mercadotecnia y Comunicación.</li>
						  	<li>Conocerás cómo compensar a los integrantes de las áreas involucradas en la comercialización para nunca perder la ruta de tus objetivos.</li>
						  	<li>Diseñarás tu Plan de Comercialización unificado con estrategias, tácticas, tiempos, movimientos, costos y métricas.</li>
						</ul>
    				</p>
    			</div>
    			...
    			<div class="content">
    				...
    				<br>
    				<ul>
    					<li>Directores Generales, Directores Comerciales, Directores de Mercadotecnia y Directores de Comunicación de Empresas de cualquier tamaño y giro; Emprendedores que buscan impulsar el desarrollo de su negocio; Start-Ups que desean crear un plan integrado para el kick-off de sus operaciones; Empresarios.</li>
    				</ul>			
    			</div>
  			</div>
  			...
  			<div id="Temario" class="w3-container w3-border city" style="display:none">
			    ...
			    <p>
			    	<ul class="ul2">
			    		<li>Como le afecta o beneficia a mi empresa lo que pasa en el mundo</li>
			    		<hr>
			    		<li>Comercialización: el romance ideal entre ventas y mercadotecnia</li>
			    		<hr>
			    		<li>La forma mas inteligente de ir al mercado</li>
			    		<hr>
			    		<li>Smarketing si es para todos</li>
			    		<hr>
			    		<li>Gnerando oportunidades de negocio mientras posiciono mi marca</li>
			    		<hr>
			    		<li>El mix perfecto para mi empresa</li>
			    		<hr>
			    		<li>De la teoria a la practica</li>
			    		<hr>
			    		<li>Mi plan de vuelo</li>
			    	</ul>
			    </p> 
  			</div>
			    	...
			    	<form action="" method="post" name="fcontacto">
				    	...
				    	<div class="form-column1-infocursos">
				    		<p>
								...
								<br>
								<input type="text" class="input-text" value="Smarketing" name="nombreDelCurso" required readonly>
							</p>
